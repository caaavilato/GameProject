 ...
 * @author Alejandra97
 */
public class ThirdLevelScreen implements Screen{
    ...
    public ThirdLevelScreen (Game game) {
        ...
        Label press2Label = new Label ("third level",font1);
     ...
     public void show() {
      ...
      public void render(float dt) {
          if (Gdx.input.justTouched()){
              game.setScreen(new PlayScreen1_2 ((AdventureGame)game));
              dispose ();
