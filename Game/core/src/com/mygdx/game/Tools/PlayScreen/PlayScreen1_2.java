...
import com.mygdx.game.Tools.B2WorldCreators.B2WorldCreator1_2;
import com.mygdx.game.Tools.Screens.GameOverScreen;
import com.mygdx.game.Tools.Screens.WinnerScreen;

/**
 *
 * @author Camilo.Avila
 */
public class PlayScreen1_2 extends PlayScreen {
           private B2WorldCreator1_2 creator;
     ...
     @Override
      public void update(float dt){
            ...
            if(finish){
                  AdventureGame.manager.get("music/Music 1_2.mp3", Music.class).stop();
                  this.dispose();
                  this.game.setScreen(new WinnerScreen(this.game));
                  return;
            }
            if(Player.dead){
                  AdventureGame.manager.get("music/Music 1_2.mp3", Music.class).stop();
