 ...
 * @author mateo
 */
public class MachineGunB extends Enemy {
      ...
      public MachineGunB(PlayScreen screen, float x, float y, boolean fireLeft) {
            super(screen, x, y);

            frames = new Array<TextureRegion>();
            for (int i = 0; i <= 2; i++) {
                  frame = new TextureRegion(screen.getAtlas().findRegion("MachineGunB"), (i * 25)+1, 0, 25, 24);
                  frames.add(frame);
            }
            ...
            setBounds(x, y, 25 / AdventureGame.PPM, 24 / AdventureGame.PPM);
      ...
      protected void defineEnemy() {
            ...
            shape.setAsBox(12 / AdventureGame.PPM, 12 / AdventureGame.PPM);
